...
jest.mock("../../server/scripts/importUnits.js", () => ({
  __esModule: true,
  default: mockImportUnits
}));

describe("📥 Import Units Script Tests", () => {
  beforeEach(() => {
  ...
  describe("Script Execution", () => {
    ...
    test("should handle execution errors", async () => {
      ...
      mockImportUnits.mockRejectedValue(error);

      // Act & Assert
      await expect(mockImportUnits()).rejects.toThrow("Import failed");
    });
  });
